  ...
  <div class="row animated fadeInUp delay-1s">
    <div class="col-md-12">
      ...
      <div class="card card-cascade narrower">
        ...
        <!--Card image-->
        <div
          class="view view-cascade gradient-card-header danger-color-dark narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center" style="background-color:#4169E1;">
