...
<head>
  ...
  <title>Smart Complaint COVID19 Apps</title>
  <!-- Font Awesome -->
        ...
        <div class="container">
          ...
          <div class="row mt-5">
            ...
            <div class="col-md-7 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
              ...
              <h6 class="mb-3 wow fadeInLeft" data-wow-delay="0.3s">Sebuah aplikasi untuk membantu masyarakat memberitahu
                secara anonim maupun tidak, disertai permintaan oleh pihak yang berkepentingan kepada pihak
                yang berwenang untuk menindak lanjuti suatu pengaduan tentang permasalahan COVID'19</h6>
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="card-body">
                    ...
                    <div class="md-form">
                      ...
                      @enderror
                      <label for="form3" class="active">NIK Anda...</label>
                    </div>
                    <div class="md-form">
