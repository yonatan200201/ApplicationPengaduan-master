...
<!-- Sidebar navigation -->
<div id="slide-out" class="side-nav fixed" style="background-image: url('{{asset('/img/virus1.jpg')}}');">
  <ul class="custom-scrollbar">
    <!-- Logo -->
    <li>
      <div class="logo-wrapper waves-light">
        <a href="#"><img src="{{asset('img/Capture.png')}}" class="img-fluid flex-center"></a>
      </div>
    </li>
    <!--/. Logo -->
    <!--Search Form-->
        ...
        <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-user"></i> Data Pengguna
          ...
          <div class="collapsible-body">
            <ul>
              ...
              @endif     
              <li><a href="{{url('santri')}}" class="waves-effect">Anggota</a>
        </li>
      </ul>
</div>
</li>
