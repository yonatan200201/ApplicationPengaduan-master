...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="{{asset('img/covid.jpg')}}">
...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
      <div class="container">
        ...
        <img src="{{asset('img/lapor.jpeg')}}" height="30" class="d-inline-block align-top"
            alt="mdb logo">
        </a>
    ...
    <!-- Navbar -->
    <!-- Full Page Intro -->
    <div class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('img/covid.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-4 white-text text-center">
              ...
              <h5 class="h5-reponsive mb-4 white-text wow fadeInDown" data-wow-delay="0.4s"><p>Pengaduan adalah pemberitahuan yang disertai permintaan oleh masyarakat kepada pihak yang berkepentingan untuk menindak menurut Hukum, terhadap seseorang yang telah melakukan Tindak Pidana Aduan yang merugikan.
